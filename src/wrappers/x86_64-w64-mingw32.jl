...
const libharfbuzz_splitpath = ["bin", "libharfbuzz-0.dll"]
...
const libharfbuzz = "libharfbuzz-0.dll"


# Relative path to `libharfbuzz_gobject`
const libharfbuzz_gobject_splitpath = ["bin", "libharfbuzz-gobject-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libharfbuzz_gobject = "libharfbuzz-gobject-0.dll"


# Relative path to `libharfbuzz_icu`
const libharfbuzz_icu_splitpath = ["bin", "libharfbuzz-icu-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libharfbuzz_icu = "libharfbuzz-icu-0.dll"


# Relative path to `libharfbuzz_subset`
const libharfbuzz_subset_splitpath = ["bin", "libharfbuzz-subset-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libharfbuzz_subset = "libharfbuzz-subset-0.dll"
